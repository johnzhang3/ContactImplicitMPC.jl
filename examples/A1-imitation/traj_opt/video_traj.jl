...
result_path = joinpath(@__DIR__, "..", "..", "..", "examples/A1-imitation/results", "video_traj")
run_path = mk_new_dir(result_path)

ref_path = joinpath(@__DIR__, "..", "..", "..", "examples/A1-imitation/from_gengshan/video_traj.json")
...
save_to_jld2(model, x_sol, u_sol, "video_traj", tolerance,  run_path)
plt_opt_foot_height("video_traj", tolerance, run_path)
