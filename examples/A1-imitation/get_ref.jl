...
cent_hopturn = JSON.parsefile("src/a1_cpp/lib/ContactImplicitMPC.jl/examples/A1-imitation/cent_ref_traj/hopturn.txt")
cent_pace = JSON.parsefile("src/a1_cpp/lib/ContactImplicitMPC.jl/examples/A1-imitation/cent_ref_traj/pace.txt")
...
cent_pace_ref_traj = cent_hopturn["Frames"]
